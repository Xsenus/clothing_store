...
- публичных универсальных `MerchantLogin` и тестовых паролей RoboKassa не предоставляет;
- для реального внешнего теста оплаты нужен ваш тестовый магазин и ваши тестовые пароли из кабинета;
- админский тест в проекте валидирует локальную форму, подписи и готовность `ResultURL`, даже если внешние учетные данные еще не заведены.
