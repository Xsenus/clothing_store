...
export const DEFAULT_HOME_TRUST_REVIEWS = {
  ...
  items: [
    {
      id: "review-darkwave",
      text: "Худи огонь! Качество реально хорошее, сидит идеально. Доставка пришла за 11 дней.",
      author: "@darkwave23",
      location: "Москва",
      source: "Otzovik",
      sourceUrl: "",
    ...
    {
      id: "review-inferno",
      text: "Футболка очень плотная, принт не трескается. Уже заказал вторую в другом цвете.",
      author: "@inferno_style",
