        ...
        const nextCollections = Array.isArray(response?.collections)
          ? response.collections
              ...
              .map((item: any) => ({
                ...
                previewTileCount: Number.isFinite(Number(item.previewTileCount)) ? Number(item.previewTileCount) : 3,
                previewRotationMode: item.previewRotationMode === "random" || item.previewRotationMode === "static" ? item.previewRotationMode : "sequential",
                previewMobileTileCount: Number.isFinite(Number(item.previewMobileTileCount)) ? Number(item.previewMobileTileCount) : 3,
                previewMobileRotationMode: item.previewMobileRotationMode === "sequential" || item.previewMobileRotationMode === "random" || item.previewMobileRotationMode === "static" ? item.previewMobileRotationMode : "inherit",
                previewMobileHeight: Number.isFinite(Number(item.previewMobileHeight)) ? Number(item.previewMobileHeight) : 260,
