...
{
    public partial class BackfillDictionarySlugsBeforeUniqueIndexes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            AddSlugAndFilterColumns(migrationBuilder, "size_dictionaries");
            AddSlugAndFilterColumns(migrationBuilder, "material_dictionaries");
            AddSlugAndFilterColumns(migrationBuilder, "color_dictionaries");
            AddSlugAndFilterColumns(migrationBuilder, "category_dictionaries");

            ApplyKnownSizeSlugs(migrationBuilder);
            BackfillUniqueSlug(migrationBuilder, "size_dictionaries");
            ApplyKnownMaterialSlugs(migrationBuilder);
            BackfillUniqueSlug(migrationBuilder, "material_dictionaries");
            ApplyKnownColorSlugs(migrationBuilder);
            BackfillUniqueSlug(migrationBuilder, "color_dictionaries");
            ApplyKnownCategorySlugs(migrationBuilder);
            BackfillUniqueSlug(migrationBuilder, "category_dictionaries");

            CreateSlugUniqueIndex(migrationBuilder, "size_dictionaries", "IX_size_dictionaries_slug");
            CreateSlugUniqueIndex(migrationBuilder, "material_dictionaries", "IX_material_dictionaries_slug");
            CreateSlugUniqueIndex(migrationBuilder, "color_dictionaries", "IX_color_dictionaries_slug");
            CreateSlugUniqueIndex(migrationBuilder, "category_dictionaries", "IX_category_dictionaries_slug");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            DropSlugAndFilterColumns(migrationBuilder, "size_dictionaries");
            DropSlugAndFilterColumns(migrationBuilder, "material_dictionaries");
            DropSlugAndFilterColumns(migrationBuilder, "color_dictionaries");
            DropSlugAndFilterColumns(migrationBuilder, "category_dictionaries");
        }

        private static void AddSlugAndFilterColumns(MigrationBuilder migrationBuilder, string table)
        {
        ...
        private static void ApplyKnownSizeSlugs(MigrationBuilder migrationBuilder)
        {
...
");
        ...
        private static void ApplyKnownMaterialSlugs(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
...
UPDATE material_dictionaries SET slug = 'denim' WHERE slug IS NULL AND lower(trim(name)) = 'деним';
");
        }

        private static void ApplyKnownColorSlugs(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
...
");
        ...
        private static void ApplyKnownCategorySlugs(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
...
");
        ...
        private static void DropSlugAndFilterColumns(MigrationBuilder migrationBuilder, string table)
        {
            migrationBuilder.DropColumn(name: "slug", table: table);
            migrationBuilder.DropColumn(name: "show_in_catalog_filter", table: table);
        }

        private static void CreateSlugUniqueIndex(MigrationBuilder migrationBuilder, string table, string indexName)
        {
...
WITH base AS (
    SELECT id,
           trim(both '-' from regexp_replace(lower(coalesce(name, '')), '[^a-z0-9]+', '-', 'g')) AS normalized
    FROM {table}
), filled AS (
    SELECT id,
           CASE
               WHEN normalized IS NULL OR normalized = '' THEN 'item'
               ELSE normalized
           END AS slug_base
    FROM base
), ranked AS (
