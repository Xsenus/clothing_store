...
public sealed class OrderEmailQueue : BackgroundService, IOrderEmailQueue
{
    ...
    private static Order CloneOrder(Order order)
    {
        return new Order
        {
            ...
            ShippingTariff = order.ShippingTariff,
            ...
            ShippingStatusDescription = order.ShippingStatusDescription,
            ShippingStatusUpdatedAt = order.ShippingStatusUpdatedAt,
            ShippingLastSyncError = order.ShippingLastSyncError,
