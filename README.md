...
## Итог последних обновлений главной страницы

### 1) Настраиваемые trust-блоки
- Добавлены настройки главной страницы в админке: hero, преимущества, блок "О нас" и ручные отзывы.
- Все новые блоки берут данные из `app_settings`, а публичная главная получает их через API публичных настроек.
- Otzovik не парсится: отзывы добавляются и редактируются вручную, при необходимости с ссылкой на оригинал.

### 2) Витрина
- Первый экран, преимущества, блок доверия и отзывы оформлены в текущей черно-белой стилистике Fashion Demon с красными акцентами.
- Текст про Poizon в дефолтных преимуществах не используется.
- Исправлена видимость контурной кнопки в темных продуктовых секциях на мобильной главной.

### 3) Проверки
- Добавлены тесты нормализации настроек главной, fallback-данных, сортировки/скрытия элементов и безопасных ссылок.
- Проверено на локальной PostgreSQL базе, восстановленной из резервной копии проекта.
